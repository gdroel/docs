---
title: 'Overview'
description: 'Web checkout for mobile apps — keep ~94% of your revenue'
icon: 'credit-card'
---

ZeroSettle In-App Purchase lets your mobile app accept payments via web checkout instead of Apple's StoreKit or Google Play Billing. You keep **~94%** of every transaction instead of 70%.

We act as the Merchant of Record — we handle payments, tax compliance, refunds, receipts, and liability. You add a few lines of code and start earning more. We support **Swift**, **Kotlin**, and **Flutter**, with React Native coming soon.
...
| **Tax handling** | Apple/Google handles | We handle |
...
Already on Stripe? With **Bring Your Own Stripe (BYOS)**, you connect your existing Stripe account and keep your products, prices, customers, and reporting. Charges go directly to your account — we add the Merchant of Record layer on top. Same 5% + 50¢ fee either way.
...
|---|---|---|
| **Stripe account** | We create one for you (Express) | You connect your own (Standard) |
