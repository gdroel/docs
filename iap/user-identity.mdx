...
// Configure
ZeroSettleIAP.shared.configure(.init(publishableKey: "pk_live_..."))
...
Entitlements can come from two sources:
...
The SDK merges entitlements from both sources when you call `restoreEntitlements()`.
