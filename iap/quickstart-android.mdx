...
| Exception | When |
|-----------|------|
| `ZeroSettleError.NotConfigured` | SDK not configured yet |
| `ZeroSettleError.Cancelled` | User cancelled checkout |
| `ZeroSettleError.ProductNotFound` | Product ID not found in catalog |
| `ZeroSettleError.CheckoutFailed` | Payment failed |
| `ZeroSettleError.UserIdRequired` | Method requires a userId |
| `ZeroSettleError.WebCheckoutDisabledForJurisdiction` | Web checkout disabled for this region |
| `ZeroSettleError.ApiError` | Network or API error |
