...
The questionnaire and retention offer are configured on the [ZeroSettle dashboard](/iap/dashboard) — no code changes needed to update questions or offers.
...
// result is CancelFlow.Result: .cancelled, .retained, or .dismissed
```
...
// result is CancelFlowResult: CANCELLED, RETAINED, or DISMISSED
```
