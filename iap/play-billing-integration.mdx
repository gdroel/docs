...
} catch (e: ZeroSettleError.ProductNotFound) {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
        ...
        Button(onClick = {
            scope.launch {
                ...
                } catch (e: ZeroSettleError.Cancelled) { /* cancelled */ }
            }
        }) {
...
The `Product` model tells you whether a Play Store product is available:
