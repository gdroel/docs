...
<Frame caption="AI-suggested product mapping with price mismatch warning and match confidence indicator">
  <img src="/images/stripe-catalog-mapping.png" alt="Stripe catalog mapping showing AI-suggested match between StoreKit and Stripe products with price mismatch warning" style={{ maxWidth: '500px' }} />
</Frame>
