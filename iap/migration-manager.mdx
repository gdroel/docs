...
Set `ZSMigrationManager.demoMode = true` before bootstrapping to preview the switch and save UI without an active StoreKit subscription. The manager synthesizes a demo offer so you can test your custom UI in the simulator.
