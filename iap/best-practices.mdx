...
|---|---|
| `ZeroSettleError` | SDK configuration and general errors |
...
| `ZeroSettleError.Cancelled` | User dismissed the checkout |
| `ZeroSettleError.CheckoutFailed` | Payment failed (with `CheckoutFailure` reason) |
...
| Cancel Custom Tab checkout | Android | `ZeroSettleError.Cancelled`, no entitlement change |
