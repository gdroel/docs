...
ZeroSettle's web checkout is built on established legal and regulatory frameworks that allow developers to offer alternative payment methods outside the App Store and Google Play billing systems. This page explains the legal basis, what the courts have said, and how different checkout methods are treated.
...
## Apple v. Epic: The Legal Basis

The legal foundation for alternative payment links in iOS apps comes from the *Epic Games v. Apple* case and its aftermath.
...
These guidelines confirm that US developers can freely include external payment links in their iOS apps without applying for a special entitlement or facing content restrictions.
...
The user taps a button in your app and is taken to Safari (or their default browser) to complete the purchase. After payment, a universal link brings them back to your app. This is the method **explicitly allowed** by Apple's updated guidelines and carries zero App Review friction.
...
Following regulatory pressure and the *Epic Games v. Google* jury verdict, Google updated its US policies to allow developers to use alternative payment methods with a reduced service fee. Apps distributed on Google Play in the US can direct users to external payment flows without violating Play Store policies.
...
ZeroSettle is designed to handle the compliance details so you can focus on your app:
